...
export const reportsMock = [
  {
    ...
    projectId: 12,
    projectName: "Reforma oficina centro",
    date: "2026-01-08",
    hours: 8,
    status: "pending",
    approvedBy: null,
    statusChangedAt: null,
    comment: "Trabajo en estructura metálica",
  ...
  },
  {
    ...
    projectId: 13,
    projectName: "Vivienda unifamiliar",
    date: "2026-01-07",
    hours: 7.5,
    status: "approved",
    approvedBy: 2,              
    statusChangedAt: "2026-01-08T09:15:00Z",
    comment: "Montaje de ventanas",
