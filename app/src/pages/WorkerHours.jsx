...
export default function WorkerHours() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 p-6 md:p-10">
      {/* Header */}
      <div className="flex justify-between items-center mb-8 max-w-4xl mx-auto">
        ...
        <Link
          to="/workerDashboard"
          className="text-indigo-600 hover:text-indigo-800 transition duration-150 font-medium flex items-center text-sm bg-indigo-50 px-3 py-1.5 rounded-full border border-indigo-100"
        >
          <svg
      ...
      <div className="max-w-4xl mx-auto">
        {/* Card total hours*/}
        <div className="bg-white/90 backdrop-blur p-6 rounded-2xl shadow-lg mb-6 border border-indigo-100 flex items-center justify-between">
          <div>
          ...
          <button
            ...
            className={`px-6 py-2 rounded-full font-semibold text-sm transition duration-300 flex items-center gap-2 ${
              view === "week"
                ...
                : "bg-white/90 text-gray-700 border border-gray-300 hover:bg-gray-100"
            }`}
          >
        ...
        {/* Grafiek */}
        <div className="bg-white/95 backdrop-blur p-6 rounded-2xl shadow-2xl w-full h-[400px] border border-slate-100">
